    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            'bg-gradient-to-r from-emerald-600 to-cyan-600 text-white hover:from-emerald-500 hover:to-cyan-500 focus:ring-emerald-500 shadow-lg shadow-emerald-500/20': variant === 'primary',
