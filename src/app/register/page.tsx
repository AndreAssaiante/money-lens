      ...
      >
        ...
        <div className="bg-gray-900/70 backdrop-blur-2xl border border-white/5 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleRegister} className="flex flex-col gap-4">
            {/* Nome */}
            <div>
              <label className="block text-xs font-medium text-gray-400 mb-1.5 ml-1">Nome completo</label>
            ...
            {/* Confirmar Senha */}
            <div>
              <label className="block text-xs font-medium text-gray-400 mb-1.5 ml-1">Confirmar senha</label>
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 pointer-events-none" />
                <input
                  type={showPassword ? 'text' : 'password'}
